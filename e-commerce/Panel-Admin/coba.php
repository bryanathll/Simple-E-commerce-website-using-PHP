<?php
    ...
    $query = mysqli_query($config, "SELECT barang.*, kategori.nama_kategori AS nama_kategori1, k.nama_kategori AS nama_kategori2 FROM barang 
    JOIN kategori ON barang.id_kategori = kategori.id_kategori
    JOIN kategori k ON barang.id_kategori2 = k.id_kategori
    WHERE barang.id_barang = '$id'");

    $product_data = mysqli_fetch_array($query);
    $querykategori = mysqli_query($config, "SELECT * FROM kategori WHERE id_kategori");
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <select name="kategori2" id="kategori2" class="form-control">
                        <option value="<?php echo $product_data["id_kategori"] ?>"> <?php echo $product_data["nama_kategori2"] ?></option>
                ...
                <div>
                    <label for="currentfoto">Foto Product</label> <br>
